...
class UserStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CheckPassWord = channel.unary_unary(
                ...
                response_deserializer=user__pb2.ChenckResponse.FromString,
                )
...
def add_UserServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CheckPassWord': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=user__pb2.ChenckResponse.SerializeToString,
            ),
    }
...
class User(object):
    ...
    def CheckPassWord(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/User/CheckPassWord',
            ...
            user__pb2.ChenckResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
